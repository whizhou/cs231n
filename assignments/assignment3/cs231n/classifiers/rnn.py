...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        # Compute loss
        # h0 = np.matmul(features, W_proj) + b_proj  # (N, H)
        ...
        _, dW_proj, db_proj = affine_backward(dh0, cache_fc)
    ...
    def sample(self, features, max_length=30):
        ...
        for i in range(max_length):
            ...
            out = np.matmul(next_h, W_vocab) + b_vocab
            max_indicies = np.argmax(out, axis=1)
            captions[:, i] = max_indicies
            x = W_embed[max_indicies]
            h0 = next_h

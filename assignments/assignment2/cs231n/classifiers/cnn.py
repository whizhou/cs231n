...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        X1, cp_cache = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        X2, fc_cache = affine_relu_forward(X1, W2, b2)
        ...
        dout, grads['W1'], grads['b1'] = conv_relu_pool_backward(dout, cp_cache)
